...
public class Constant {
    ...
    public static final String BG_IMG_PATH = "src\\main\\resources\\image\\bgday.png"; 

    public static final String BG_DARK_IMG_PATH = "src\\main\\resources\\image\\bgnight.png"; 
